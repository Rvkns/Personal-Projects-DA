...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-yb@t3qmw#145#vouwe+kmp1580odom&5pt*^c=b5v76ajexld!",
)
...
LOGIN_URL = "login"
LOGIN_REDIRECT_URL = "bundles:bundle_list"
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@dropshipbundles.example")
